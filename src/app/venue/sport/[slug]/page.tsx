...
export default function SportVenuePage({ params }: { params: Promise<{ slug: string }> }) {
      ...
      try {
        ...
        for (const ev of allEvents) {
          ...
          if (toSlug(vname) === slug) {
            ...
            const cat = ev.category as Record<string, unknown> | undefined;
            ...
            venueEvents.push({
              ...
              category: cat ? { name: String(cat.name || '') } : undefined,
              min_price: pricing ? Number(pricing.amount || 0) : (ev.min_price as number | undefined),
