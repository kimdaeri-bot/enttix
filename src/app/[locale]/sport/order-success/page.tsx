  ...
  return (
    <main className="min-h-screen bg-[#F5F7FA]">
      ...
      <div className="max-w-[560px] mx-auto px-4 py-16 text-center">
        ...
        <h1 className="text-[28px] font-extrabold text-[#171717] mb-2">{t('order_confirmed')}</h1>
        ...
        <div className="bg-[#EFF6FF] rounded-[12px] px-4 py-3 mb-8 text-left flex gap-3">
          ...
          <p className="text-[13px] text-[#1D4ED8] leading-relaxed">
            <strong>{t('check_email')}</strong> for your ticket confirmation and delivery instructions.
          </p>
        </div>
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Link href="/" className="flex-1 py-3 px-6 rounded-[12px] bg-[#2B7FFF] hover:bg-[#1D6AE5] text-white text-[15px] font-bold transition-colors text-center">Browse More Events</Link>
          <Link href="/mypage" className="flex-1 py-3 px-6 rounded-[12px] border border-[#E5E7EB] bg-white hover:bg-[#F8FAFC] text-[#374151] text-[15px] font-semibold transition-colors text-center">My Orders</Link>
        </div>
      </div>
    </main>
  );
