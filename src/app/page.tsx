              ...
              <div className="bg-white rounded-full shadow-xl flex items-center px-2 py-2">
                ...
                <div className="flex items-center gap-2 px-4 py-2 flex-1 min-w-0">
                  ...
                  <div>
                    ...
                    <input type="text" placeholder="City" className="text-[14px] text-[#171717] outline-none w-full placeholder:text-[#CBD5E1] bg-transparent" />
                  </div>
                </div>
                {/* Divider */}
                ...
                <div className="flex items-center gap-2 px-4 py-2 flex-1 min-w-0">
                  ...
                  <div>
                    ...
                    <input type="text" placeholder="Date" className="text-[14px] text-[#171717] outline-none w-full placeholder:text-[#CBD5E1] bg-transparent" />
                  </div>
                </div>
                {/* Divider */}
                <div className="w-px h-8 bg-[#E5E7EB]" />
                ...
                <div className="flex items-center gap-2 px-4 py-2 flex-1 min-w-0">
                  ...
                  <div>
                    ...
                    <input type="text" placeholder="Event..." className="text-[14px] text-[#171717] outline-none w-full placeholder:text-[#CBD5E1] bg-transparent" />
                  </div>
                </div>
                {/* Search Button */}
                <button className="bg-[#2B7FFF] hover:bg-[#1D6AE5] text-white font-semibold text-[13px] px-6 py-2.5 rounded-full transition-colors active:scale-95 flex-shrink-0">
                  Search
                </button>
              </div>
            </div>
