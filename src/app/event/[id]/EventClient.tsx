          ...
          <div className="w-full lg:w-[380px] flex-shrink-0">
            ...
            {cart && (
              <div className="bg-white rounded-[16px] border border-[#E5E7EB] p-6">
                ...
                <Link href="/checkout" className="block w-full text-center bg-[#2B7FFF] hover:bg-[#1D6AE5] text-white font-semibold text-[14px] py-3.5 rounded-[12px] transition-colors">
                  Checkout
                </Link>
