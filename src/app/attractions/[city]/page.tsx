...
const CITY_MAP: Record<string, {
  ...
  seville:         { id: 65870,  name: 'Seville',         tiqetsSlug: 'seville-attractions-c65870',         photo: 'photo-1509899595012-e9c19cba1d57',  desc: "Flamenco, Gothic cathedral, orange trees and the golden light of Andalusia." },
  hamburg:         { id: 64886,  name: 'Hamburg',         tiqetsSlug: 'hamburg-attractions-c64886',         photo: 'photo-1558618047-3c8c96f7d900',     desc: "Germany's port city — Speicherstadt warehouses, Reeperbahn nightlife and the Elbphilharmonie." },
  ...
  palermo:         { id: 71428,  name: 'Palermo',         tiqetsSlug: 'palermo-attractions-c71428',         photo: 'photo-1589306969225-8b7f26f5e3c0',  desc: "Sicily's capital: Arab-Norman architecture, street food markets and Baroque splendor." },
  ...
  verona:          { id: 71506,  name: 'Verona',          tiqetsSlug: 'verona-attractions-c71506',          photo: 'photo-1539966975862-1506e91e88c2',  desc: "Shakespeare's city of love — the Roman Arena, Juliet's balcony and endless romance." },
  nice:            { id: 66770,  name: 'Nice',            tiqetsSlug: 'nice-attractions-c66770',            photo: 'photo-1493683803644-0e8d47c5ca69',  desc: "Azure coast, Promenade des Anglais, old town markets and gateway to the French Riviera." },
  turin:           { id: 71534,  name: 'Turin',           tiqetsSlug: 'turin-attractions-c71534',           photo: 'photo-1574804842743-74dc8f1d11f4',  desc: "Italy's elegant baroque city — Mole Antonelliana, Egyptian Museum and world-class chocolate." },
  ...
  bordeaux:        { id: 67101,  name: 'Bordeaux',        tiqetsSlug: 'bordeaux-attractions-c67101',        photo: 'photo-1576162429-b5c4e62e7e50',     desc: "The wine capital of the world — 18th-century architecture and La Cité du Vin." },
  ...
  valletta:        { id: 73787,  name: 'Valletta',        tiqetsSlug: 'valletta-attractions-c73787',        photo: 'photo-1595880576980-b29434a6d98e',  desc: "Europe's smallest capital — baroque palaces, Caravaggio paintings and Grand Harbour views." },
  ...
  salzburg:        { id: 60346,  name: 'Salzburg',        tiqetsSlug: 'salzburg-attractions-c60346',        photo: 'photo-1599982890968-83e0acfbe35b',  desc: "Sound of Music, Mozart's birthplace, Hohensalzburg fortress and Alpine views." },
  ...
  oslo:            { id: 75084,  name: 'Oslo',            tiqetsSlug: 'oslo-attractions-c75084',            photo: 'photo-1561015366-b8bc1b35bb1c',     desc: "Viking ships, the Munch Museum, Vigeland sculptures and Norway's fjord gateway." },
  ...
  tallinn:         { id: 65702,  name: 'Tallinn',         tiqetsSlug: 'tallinn-attractions-c65702',         photo: 'photo-1548602088-9d12a4f9c10e',     desc: "One of Europe's best-preserved medieval Old Towns, on the shores of the Baltic Sea." },
  vilnius:         { id: 73352,  name: 'Vilnius',         tiqetsSlug: 'vilnius-attractions-c73352',         photo: 'photo-1554929039-534f8a59e7f6',     desc: "Lithuania's baroque capital — Gediminas Castle, Gate of Dawn and a thriving café culture." },
  lucerne:         { id: 62662,  name: 'Lucerne',         tiqetsSlug: 'lucerne-attractions-c62662',         photo: 'photo-1586500036706-41963de39e8c',  desc: "Switzerland's most romantic city — Chapel Bridge, Lake Lucerne and the Alps." },
  // ── EMEA 신규
  'abu-dhabi':     { id: 60013,  name: 'Abu Dhabi',       tiqetsSlug: 'abu-dhabi-attractions-c60013',       photo: 'photo-1580672850367-a4a84d9cbc38',  desc: "Sheikh Zayed Mosque, Ferrari World, Louvre Abu Dhabi and the UAE's grand capital." },
  ...
  luxor:           { id: 65786,  name: 'Luxor',           tiqetsSlug: 'luxor-attractions-c65786',           photo: 'photo-1547523196-02ab8ebc8fbe',     desc: "The world's greatest open-air museum — Karnak Temple, Valley of the Kings and Nile cruises." },
  ...
  // ── Americas 신규
  'las-vegas':     { id: 82073,  name: 'Las Vegas',       tiqetsSlug: 'las-vegas-attractions-c82073',       photo: 'photo-1588392382834-a891154bca4d',  desc: "The Entertainment Capital of the World — shows, casinos, Cirque du Soleil and the Strip." },
  ...
  'los-angeles':   { id: 81810,  name: 'Los Angeles',     tiqetsSlug: 'los-angeles-attractions-c81810',     photo: 'photo-1543429258-b16fabe1d04e',     desc: "Hollywood, Universal Studios, Griffith Observatory and year-round California sunshine." },
  ...
  boston:          { id: 80874,  name: 'Boston',          tiqetsSlug: 'boston-attractions-c80874',          photo: 'photo-1570197571499-6d9e8e66c0e8',  desc: "Freedom Trail, Harvard, lobster rolls and America's most historically rich city." },
  tulum:           { id: 109113, name: 'Tulum',           tiqetsSlug: 'tulum-attractions-c109113',          photo: 'photo-1533862963240-a6dac5ef7b61',  desc: "Clifftop Mayan ruins, cenotes, white beaches and eco-chic jungle retreats." },
  ...
  'new-orleans':   { id: 80162,  name: 'New Orleans',     tiqetsSlug: 'new-orleans-attractions-c80162',     photo: 'photo-1577996394613-37a26fc7ba85',  desc: "Jazz music, Mardi Gras, Bourbon Street, ghost tours and Creole cuisine." },
  'playa-del-carmen':{ id: 73927, name: 'Playa del Carmen',tiqetsSlug:'playa-del-carmen-attractions-c73927', photo: 'photo-1552074284-83408e9e5020',    desc: "Caribbean beaches, 5th Avenue shopping, cenotes and the Riviera Maya's beating heart." },
  ...
  montreal:        { id: 25,     name: 'Montreal',        tiqetsSlug: 'montreal-attractions-c25',           photo: 'photo-1555883006-0828a1db5814',     desc: "French flair in North America — festivals, bagels, underground city and vibrant art scene." },
  ...
  cusco:           { id: 75323,  name: 'Cusco',           tiqetsSlug: 'cusco-attractions-c75323',           photo: 'photo-1589557059453-2d5bc0d7fb98',  desc: "Gateway to Machu Picchu — Inca heritage, colonial churches and Andean culture at 3,400m." },
  // ── APAC 신규
  ...
  phuket:          { id: 78451,  name: 'Phuket',          tiqetsSlug: 'phuket-attractions-c78451',          photo: 'photo-1552685751-74e92c0acb7a',     desc: "Crystal-clear bays, Phi Phi Islands, Big Buddha, Bangla Road and the Andaman Sea." },
  ...
  'gold-coast':    { id: 60442,  name: 'Gold Coast',      tiqetsSlug: 'gold-coast-attractions-c60442',      photo: 'photo-1577696680467-c9fe82c79c41',  desc: "Surfers Paradise, theme parks, beaches and Australia's most glamorous resort city." },
  'ho-chi-minh':   { id: 272460, name: 'Ho Chi Minh',     tiqetsSlug: 'ho-chi-minh-attractions-c272460',    photo: 'photo-1583418855642-d0a8bf2f7c64',  desc: "War Remnants Museum, Cu Chi Tunnels, French colonial buildings and Vietnam's economic hub." },
  ...
  'siem-reap':     { id: 72961,  name: 'Siem Reap',       tiqetsSlug: 'siem-reap-attractions-c72961',       photo: 'photo-1552301726-9e19e23a1d99',     desc: "Angkor Wat — the world's largest religious monument and the jewel of Khmer civilization." },
  ...
  hanoi:           { id: 82689,  name: 'Hanoi',           tiqetsSlug: 'hanoi-attractions-c82689',           photo: 'photo-1555990881-0d3d3bc0ace1',     desc: "Hoan Kiem Lake, Old Quarter street food, Ho Chi Minh Mausoleum and Halong Bay trips." },
